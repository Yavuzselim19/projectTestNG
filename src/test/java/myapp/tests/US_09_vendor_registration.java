...
import static myapp.utilities.ReusableMethods.clickWithTimeOut;
import static myapp.utilities.WaitUtils.waitForVisibility;

public class US_09_vendor_registration {
    ...
    public void Test() throws InterruptedException {
        ...
        Driver.getDriver().findElement(By.xpath("//input[@name='user_email']")).sendKeys(Keys.CONTROL,"v");
        Thread.sleep(1000);
